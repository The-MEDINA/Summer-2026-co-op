...
public class EnemyCard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        thisClickHandler.CardData = new NewVirtualCardParent(1, health, 20, NewVirtualCardParent.type.minion, NewVirtualCardParent.effect.none, NewVirtualCardParent.location.deck);
    }
}
